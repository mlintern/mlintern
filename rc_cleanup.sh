...
if [ ${SERVICE} == "blog" ]; then
	for i in $(svn list https://vault.internal.compendiumblogware.com/svn/blog/application/tags | grep "\-RC"); do
		svn rm -m "RC Cleanup (${i}), refs #${TICKET}" https://vault.internal.compendiumblogware.com/svn/blog/application/tags/${i}
	done
